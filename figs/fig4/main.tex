...
%   \readlist\Nstr{n,20,10,5, } % array of string number of nodes per layer
%   \readlist\Cstr{\strut x,a^{(\prev)},a^{(\prev)},a^{(\prev)},depth} % array of coefficient symbol per layer
...
% %   \node[above=5,align=center,mygreen!60!black] at (N1-1.90) {input\\[-0.2em]layer};
% %   \node[above=2,align=center,myblue!60!black] at (N3-1.90) {hidden layers};
% %   \node[above=40,align=center,myred!60!black] at (N\Nnodlen-1.90) {output\\[-0.2em]layer};
...
% \begin{figure}[H]
    ...
    \centering
    % \includegraphics[width=4.5in]{./figs/dnn.jpg}
    ...
    % \caption{Schematic representation of the DNN architecture used}
    \label{dnn}
% \end{figure}
